...
2. The 'Binary F6' method of measuring the efficiency of genetic algorithms.
3. The term 'genetic algorithm' can be misleading in the sense that there isn't necessarily a strong link between any given genetic algorithm and the natural behavior of genes in nature.
